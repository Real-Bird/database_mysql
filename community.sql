...
VALUES (1, '씨에스에스', '퍼킹 css', '자고싶은데 잘 수가 없어요... ', 0, NOW());

DELETE FROM maincont
WHERE m_num = 1;
...
INSERT INTO maincont(m_num, m_writer, m_title, m_content, m_like, m_regdate)
VALUES (2, (SELECT * FROM anonymous ORDER BY RAND() LIMIT 1), '잠이 부족해요', '자고싶지만 자면 안될 것 같아요... 하지만 자고 싶어요 ', DEFAULT, '2021-06-13-17:00');
#NOW().
INSERT INTO maincont(m_num, m_writer, m_title, m_content, m_like, m_regdate)
VALUES (3, (SELECT * FROM anonymous ORDER BY RAND() LIMIT 1), '취준이 끝나긴 할까요', '오늘도 탈락하고 자소서 써야하는데 의욕이 안 나네요ㅠㅠ ', DEFAULT, '2021-06-13-17:33');

INSERT INTO maincont(m_num, m_writer, m_title, m_content, m_like, m_regdate)
VALUES (5, (SELECT * FROM anonymous ORDER BY RAND() LIMIT 1), '여러분은 잘 지내시나요? ', '집에만 있으니까 너무 우울하고 무기력해지네요 ', DEFAULT, '2021-06-14-11:53');

INSERT INTO maincont(m_num, m_writer, m_title, m_content, m_like, m_regdate)
VALUES (6, (SELECT * FROM anonymous ORDER BY RAND() LIMIT 1), '직장 상사 때문에 너무 스트레스입니다', '그만 좀 갈궈', DEFAULT, '2021-06-14-12:53');

INSERT INTO maincont(m_num, m_writer, m_title, m_content, m_like, m_regdate)
VALUES (7, (SELECT * FROM anonymous ORDER BY RAND() LIMIT 1), '제 마음대로 되는게 없네요', '시험도 망하고 팀플도 망하고 동아리도 참여 못하고 진짜 뭐 하나 제대로 되는게 없어요... ', DEFAULT, '2021-06-14-13:03');
...
INSERT INTO maincont(m_num, m_writer, m_title, m_content, m_like, m_regdate)
VALUES (10, (SELECT * FROM anonymous ORDER BY RAND() LIMIT 1), '오늘 생일인데 축하해주는 사람이 없어요', '고시하다가 인간관계가 다 끊겼어요... 혼자 축하할 생각하니까 좀 우울해지네요', DEFAULT, NOW());

INSERT INTO maincont(m_num, m_writer, m_title, m_content, m_like, m_regdate)
VALUES (11, (SELECT * FROM anonymous ORDER BY RAND() LIMIT 1), '오늘 생일인데 축하해주는 사람이 없어요', '고시하다가 인간관계가 다 끊겼어요... 혼자 축하할 생각하니까 좀 우울해지네요', DEFAULT, NOW());
